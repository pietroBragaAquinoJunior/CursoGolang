...
func BuscaCepHandler(w http.ResponseWriter, r *http.Request) {
	...
	//Chama Função para ter a struct ViaCep com as informações
	...
	//Agora eu transformar essa struct para json (Marshal) e ao mesmo tempo como resposta ao get. posso usar encoder.
	err = json2.NewEncoder(w).Encode(viacep)
	if err != nil {
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
